...
LOGIN_GUI.txt = {
    ...
    ["login_ok"] = dxCreateTexture("login/files/img/login_ok.png", "argb", true, "wrap"),
    ["login_error"] = dxCreateTexture("login/files/img/login_error.png", "argb", true, "wrap"),
}
...
LOGIN_GUI.scale = {
    ...
    ["login_ok"] = {w= 552*zoom, h= 69*zoom},
    ["login_error"] = {w= 556*zoom, h= 104*zoom},
}
...
LOGIN_GUI.pos = {
    ...
    ["login_error"] = {x= 882*zoom, y= 630*zoom},
    ["login_ok"] = {x= 882*zoom, y= 630*zoom},
    ["label_ok"] = {x= 62*zoom, y= LOGIN_GUI.scale.login_ok.h/2},
    ["label_error"] = {x= 90*zoom, y= LOGIN_GUI.scale.login_error.h/2-10*zoom},
    ["label_error2"] = {x= 90*zoom, y= LOGIN_GUI.scale.login_error.h/2+20*zoom},
...
LOGIN_GUI.fonts = {
    ...
    ["medium_12"] = dxCreateFont("resources/fonts/Roboto-Medium.ttf", 12*zoom, false),
